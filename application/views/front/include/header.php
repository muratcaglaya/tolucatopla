		...
		<div class="container-menu-header">
			<div class="topbar">
				<div class="topbar-social">
					<a target="_blank" href="https://facebook.com/<?=$config->facebook;?>" class="topbar-social-item fa fa-facebook"></a>
					<a target="_blank" href="https://instagram.com/<?=$config->instagram;?>" class="topbar-social-item fa fa-instagram"></a>
					<a target="_blank" href="https://twitter.com/<?=$config->twitter;?>" class="topbar-social-item fa fa-twitter"></a>
					<a target="_blank" href="https://youtube.com/<?=$config->youtube;?>" class="topbar-social-item fa fa-youtube-play"></a>
				</div>
			...
			<div class="wrap_header">
				...
				<a href="<?=base_url('home');?>" class="logo">
					<img src="<?php echo base_url($config->logo);?>" alt="<?=$config->title;?>">
				</a>
				...
				<div class="wrap_menu">
					<nav class="menu">
						<ul class="main_menu">
							...
							<li <?php if($this->uri->segment(2)=="erkek"){echo' class="sale-noti"';}?>>
								<a href="<?=base_url('kategori/erkek');?>">Erkek</a>
							</li>

							<li <?php if($this->uri->segment(2)=="kadin"){echo' class="sale-noti"';}?>>
								<a href="<?=base_url('kategori/kadin');?>">Kadın</a>
							</li>

							<li <?php if($this->uri->segment(2)=="cocuk"){echo' class="sale-noti"';}?>>
								<a href="<?=base_url('kategori/cocuk');?>">Çocuk</a>
							</li>
