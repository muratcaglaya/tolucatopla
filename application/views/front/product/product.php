...
<!-- breadcrumb -->
	<div class="bread-crumb bgwhite flex-w p-l-52 p-r-15 p-t-30 p-l-15-sm">
		...
		<?php 
			if($product->category==1){$title="Erkek";$link=base_url('kategori/erkek');}
			  elseif($product->category==2){$title="Kadın";$link=base_url('kategori/kadin');}
			  else{$title="Çocuk";$link=base_url('kategori/cocuk');}
		?>
		<a href="<?=$link;?>" class="s-text16">
			<?=$title;?>
			<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>

		<a href="#" class="s-text16">
			<?=Kategori::find($product->subcategory)->name;?>
			<i class="fa fa-angle-right m-l-8 m-r-9" aria-hidden="true"></i>
		</a>
	...
	<div class="container bgwhite p-t-35 p-b-80">
		<div class="flex-w flex-sb">
			...
			<div class="w-size14 p-t-30 respon5">
				...
				<div class="p-t-33 p-b-60">
					<div class="flex-m flex-w p-b-10">
						<div class="s-text15 w-size15 t-center">
							<?php echo Secenekler::find($stocktype->options)->name;?>
						</div>
					...
					<?php if($stocktype->options2){?>
						<div class="flex-m flex-w">
							<div class="s-text15 w-size15 t-center">
								<?php echo Secenekler::find($stocktype->options2)->name;?>
							</div>
				...
				<div class="p-b-45">
					<span class="s-text8">Etiketler: <?=$product->tag;?></span>
				</div>
