...
<head>
  ...
  <title><?php if(isset($head)){echo $head.' |';} ?>  eTicaret</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url('assets/back/'); ?>index2.html" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="<?php echo base_url('assets/back/'); ?>#" class="sidebar-toggle" data-toggle="push-menu" role="button">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu">
            <a href="<?php echo base_url('assets/back/'); ?>#" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="<?php echo base_url('assets/back/'); ?>#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/back/'); ?>dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="<?php echo base_url('assets/back/'); ?>#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/back/'); ?>dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
              ...
              <li class="footer"><a href="<?php echo base_url('assets/back/'); ?>#">See All Messages</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown notifications-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer"><a href="<?php echo base_url('assets/back/'); ?>#">View all</a></li>
            </ul>
          </li>
          ...
          <li class="dropdown tasks-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="footer">
                <a href="<?php echo base_url('assets/back/'); ?>#">View all tasks</a>
              </li>
            </ul>
          </li>
          ...
          <li class="dropdown user user-menu">
            <a href="<?php echo base_url('assets/back/'); ?>#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/back/'); ?>dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-body">
                <div class="row">
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url('assets/back/'); ?>#">Followers</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url('assets/back/'); ?>#">Sales</a>
                  </div>
                  <div class="col-xs-4 text-center">
                    <a href="<?php echo base_url('assets/back/'); ?>#">Friends</a>
                  </div>
                </div>
                <!-- /.row -->
              </li>
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?php echo base_url('assets/back/'); ?>#" class="btn btn-default btn-flat">Profile</a>
                </div>
                <div class="pull-right">
                  <a href="<?php echo base_url('assets/back/'); ?>#" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
          ...
          <li>
            <a href="<?php echo base_url('assets/back/'); ?>#" data-toggle="control-sidebar"><i class="fa fa-gears"></i></a>
          </li>
        </ul>
      </div>
