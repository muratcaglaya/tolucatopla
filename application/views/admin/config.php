  ...
  <div class="row">
    <div class="col-md-6">
      <div class="box box-solid">
        <div class="box-body">
          <form autocomplete="off" method="post" action="<?php echo base_url('admin/web_settings');?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="email" name="email" required class="form-control" value="<?=$config->mail ?>" />            
            </div>
            <div class="form-group">
